...
@KafkaListener(offsetReset = OffsetReset.EARLIEST,
        properties = { @Property(name = ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG,
                value = "com.dataplatform.processor.consumers.tranformers.StoredRawDataEventDeserializer"),
...
public class CommitRawDataConsumer {
    ...
    public CommitRawDataConsumer(IngestDataService ingestDataService) {
    ...
    public void receive(ConsumerRecord<String, StoredRawData> record) {
        Optional.ofNullable(record.value()).ifPresent(ingestDataService::writeData);
    }
}
